...
struct RoutineTrackerView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 16) {
                    ...
                    HStack {
                        ...
                        .disabled(routineManager.getRoutineByTimeOfDay(selectedTab) == nil)
                    }
                    ...
                    // Loading indicator or Routine steps
                    if routineManager.isLoading {
                        ...
                        VStack(spacing: 16) {
                            if let selectedRoutineData = routineManager.getRoutineByTimeOfDay(selectedTab) {
                                ...
                                Text("No \(selectedTab.lowercased()) routine found")
                                    .font(.headline)
                                    .foregroundColor(Color("CharcoalGray").opacity(0.7))
                                    .padding(.vertical, 40)
                            }
        ...
        .onAppear {
            // Refresh routines when view appears
            routineManager.loadRoutinesFromFirebase()
        }
    }
